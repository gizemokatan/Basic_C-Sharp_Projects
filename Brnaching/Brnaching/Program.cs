...

{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string comparisonResult = currentTemperature == roomTemperature ? "It is room temp." : "It is not.";
            ...
            //else if (currentTemperature > roomTemperature)
            //{
            //    Console.WriteLine("Current temperature is warmer than room temperature");
            //}
            //else if (currentTemperature < roomTemperature)
            //{
